                            ...
                            <div class="input-wrapper">
                                ...
                                <div class="dropdown-wrapper">
                                    <select id="presetBoards">
                                        ...
                                        <option value='[["2",".",".","3",".",".",".",".","."],["8",".","4",".","6","2",".",".","3"],[".","1","3","8",".",".","2",".","."],[".",".",".",".","2",".","3","9","."],["5",".","7",".",".",".","6","2","1"],[".","3","2",".",".",".",".",".","."],[".","2",".",".",".","9","1","4","."],["6",".","1","2","5",".","8",".","9"],[".",".",".",".",".","1",".",".","2"]]'>Preset 3</option>
                                    </select>
  ...
  if (refreshButton) {
    refreshButton.addEventListener("click", () => {
      ...
      if (board.initializeEmptyBoard) {
        ...
        console.error("initializeEmptyBoard function is not defined in the board object.");
      }
    });
  }
});
